            ...
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left flex flex-col justify-center">
              ...
              <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
                <div className="inline-flex items-center px-4 py-2 rounded-full border border-[#D4A373]/40 bg-[#D4A373]/10 text-[#0F2C59] text-sm font-medium mb-8 shadow-2xs">
                  ...
                  {dict.hero.sundayService}
                </div>
                
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <button 
                    onClick={() => handleTabClick('Contact')}
                    className="inline-flex items-center justify-center px-8 py-3.5 border border-transparent text-base font-semibold rounded-full shadow-md text-white bg-[#C82323] hover:bg-[#a11b1b] transition-all hover:scale-[1.02] active:scale-[0.98] whitespace-nowrap cursor-pointer"
                  >
                    {dict.hero.planVisit}
                  </button>
                  <button 
                    onClick={() => handleTabClick('Cell Group')}
                    className="inline-flex items-center justify-center px-8 py-3.5 border-2 border-[#0F2C59] text-base font-semibold rounded-full text-[#0F2C59] bg-white hover:bg-gray-50 transition-all hover:scale-[1.02] active:scale-[0.98] whitespace-nowrap shadow-xs cursor-pointer"
                  >
                    {dict.hero.connectCell}
