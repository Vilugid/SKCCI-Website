      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          <h1 className="text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl font-serif">
            {dict.welcomeKit.title}
          </h1>
          <p className="mt-4 max-w-2xl text-xl text-gray-500 mx-auto">
            {dict.welcomeKit.subtitle}
          </p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:gap-12">
          ...
          <div className="bg-amber-50 rounded-3xl p-8 sm:p-10 border border-amber-100 flex flex-col items-start shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-3">{dict.welcomeKit.gospelTitle}</h3>
            <p className="text-base text-gray-700 flex-grow mb-8 leading-relaxed">
              {dict.welcomeKit.gospelDesc}
            </p>
            <button 
              onClick={() => handleTabClick && handleTabClick('Gospel')}
              className="inline-flex items-center justify-center px-6 py-3.5 border border-transparent text-base font-medium rounded-xl text-white bg-[#C82323] hover:bg-[#a11b1b] transition-colors w-full sm:w-auto shadow-sm cursor-pointer"
            >
              {dict.welcomeKit.readGospel}
            </button>
          </div>
          ...
          <div className="bg-blue-50 rounded-3xl p-8 sm:p-10 border border-blue-100 flex flex-col items-start shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-3">{dict.welcomeKit.plan100Title}</h3>
            <p className="text-base text-gray-700 flex-grow mb-8 leading-relaxed">
              {dict.welcomeKit.plan100Desc}
            </p>
            <button 
              onClick={() => handleTabClick && handleTabClick('100 Days Bible Plan')}
              className="inline-flex items-center justify-center px-6 py-3.5 border border-transparent text-base font-medium rounded-xl text-white bg-blue-600 hover:bg-blue-700 transition-colors w-full sm:w-auto shadow-sm cursor-pointer"
            >
              {dict.welcomeKit.startPlan100}
            </button>
          </div>
        </div>
        ...
        <div className="mt-24 mb-16 text-center">
          <div className="relative">
            ...
            <div className="relative flex justify-center">
              <span className="px-6 bg-white text-2xl font-bold text-gray-900 font-serif">{dict.welcomeKit.connectTitle}</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 items-start">
          ...
          <div className="space-y-12">
            <div className="flex">
              ...
              <div className="ml-6">
                <h3 className="text-xl font-medium text-gray-900">{dict.welcomeKit.sundayTitle}</h3>
                <p className="mt-2 text-base text-gray-600 leading-relaxed">
                  {dict.welcomeKit.sundayDesc}
                </p>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div className="ml-6">
                <h3 className="text-xl font-medium text-gray-900">{dict.welcomeKit.cellTitle}</h3>
                <p className="mt-2 text-base text-gray-600 leading-relaxed">
                  {dict.welcomeKit.cellDesc}
                </p>
              </div>
            </div>
          </div>
